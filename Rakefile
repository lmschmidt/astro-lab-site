...
def listen_handler(base, options)
  ...
  task :build do
    ...
    system "env LANG=\"en_US.UTF-8\" bundle exec jekyll build --destination /Library/WebServer/Documents/jekylltest/ --watch" # environmental variable to fix locale issue
